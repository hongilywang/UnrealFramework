...
ARaceUnrealFrameworkHud::ARaceUnrealFrameworkHud()
{
	static ConstructorHelpers::FObjectFinder<UFont> Font(TEXT("/Engine/EngineFonts/RobotoDistanceField"));
	HUDFont = Font.Object;
}

void ARaceUnrealFrameworkHud::DrawHUD()
{
	Super::DrawHUD();
	...
	if (bWantHUD == true)
	{
		...
		ARaceUnrealFrameworkPawn* Vehicle = Cast<ARaceUnrealFrameworkPawn>(GetOwningPawn());
